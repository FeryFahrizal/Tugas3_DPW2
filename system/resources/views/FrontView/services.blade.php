...
<html>
	...
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="{{ url('public/template') }}/css/icomoon.css">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="{{ url('public/template') }}/css/bootstrap.css">

	<!-- Flexslider  -->
	<link rel="stylesheet" href="{{ url('public/template') }}/css/flexslider.css">

	<!-- Owl Carousel  -->
	<link rel="stylesheet" href="{{ url('public/template') }}/css/owl.carousel.min.css">
	<link rel="stylesheet" href="{{ url('public/template') }}/css/owl.theme.default.min.css">

	<!-- Theme style  -->
	<link rel="stylesheet" href="{{ url('public/template') }}/css/style.css">

	<!-- Modernizr JS -->
	<script src="{{ url('public/template') }}/js/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-xs-2">
					<div id="fh5co-logo"><a href="/index">Shop.</a></div>
				</div>
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(public/template/images/img_bg_2.jpg);">
	...
	<!-- jQuery Easing -->
	<script src="{{ url('public/template') }}/js/jquery.easing.1.3.js"></script>
	<!-- Bootstrap -->
	...
	<!-- countTo -->
	<script src="{{ url('public/template') }}/js/jquery.countTo.js"></script>
	<!-- Flexslider -->
	<script src="{{ url('public/template') }}/js/jquery.flexslider-min.js"></script>
	<!-- Main -->
